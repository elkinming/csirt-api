...
namespace AisinIX.CSIRT.CompanyRoleOps.DBAccessors
{
    public interface ICompanyRoleOpsDBAccessor
    {
        ...
        Task<IEnumerable<CompanyRoleOpsModel>> GetAllCompanyRoleOpsRecords();
        ...
        Task<bool> InsertCompanyRoleOpsRecordsArray(IEnumerable<CompanyRoleOpsModel> companyRoleOpsList);
    }
}
