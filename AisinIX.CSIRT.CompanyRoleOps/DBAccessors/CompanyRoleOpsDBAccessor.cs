...
namespace AisinIX.CSIRT.CompanyRoleOps.DBAccessors
{
    public class CompanyRoleOpsDBAccessor: ICompanyRoleOpsDBAccessor
    {
        ...
        public async Task<IEnumerable<CompanyRoleOpsModel>> GetAllCompanyRoleOpsRecords()
        {
            return await dbContext.DbConnection.QueryAsync<CompanyRoleOpsModel>(GetAllCompanyRoleOpsRecordsSql());
        }

        public async Task<bool> InsertCompanyRoleOpsRecordsArray(IEnumerable<CompanyRoleOpsModel> companyRoleOpsList)
        {
