...
public class CompanyController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAllCompanyData()
    {
        ...
        ApiResponse<List<CompanyModel>> response = new ApiResponse<List<CompanyModel>>();
    ...
    [HttpPost]
    [Route("company/list")]
    public async Task<IActionResult> InsertCompanyList([FromBody] List<CompanyModel> companies)
    {
