...
namespace AisinIX.CSIRT.WebApi.Controllers
{
    ...
    public class CompanyRoleOpsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllCompanyRoleOps()
        {
            ...
            var response = new ApiResponse<List<CompanyRoleOpsModel>>
            {
                statusCode = 200,
                message = "Success",
        ...
        public async Task<IActionResult> InsertCompanyRoleOpsList([FromBody] List<CompanyRoleOpsModel> companyRoleOpsList)
        {
