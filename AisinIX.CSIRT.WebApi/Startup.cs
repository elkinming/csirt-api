...
using AisinIX.CSIRT.Company.Services;
using AisinIX.CSIRT.CompanyRoleOps.DBAccessors;
using AisinIX.CSIRT.CompanyRoleOps.Services;
...
namespace AisinIX.CSIRT.WebApi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AisinIX.CSIRT.WebApi v1"));
            }
