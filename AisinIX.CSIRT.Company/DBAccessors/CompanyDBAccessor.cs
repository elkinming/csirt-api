...
namespace AisinIX.CSIRT.Company.DBAccessors
{
    public class CompanyDBAccesor: ICompanyDBAccesor
    {
        ...
        public async Task <IEnumerable <CompanyModel>> GetAllCompanyRecords()
        {
            return await dbContext.DbConnection.QueryAsync<CompanyModel>(GetAllCompanyRecordsSql());
        }

        public async Task<bool> InsertCompanyRecordsArray(IEnumerable<CompanyModel> companies)
        {
