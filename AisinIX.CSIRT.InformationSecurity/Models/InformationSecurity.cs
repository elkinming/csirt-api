namespace AisinIX.CSIRT.InformationSecurity.Models
{
    public class InformationSecurityModel
    {
    ...
    public class InformationSecurityDto: InformationSecurityModel
    {
        public bool isMainRecord { get; set; } = false;
        public int childrenNumber { get; set; } = 0;

        public InformationSecurityDto(InformationSecurityModel src)
        {
